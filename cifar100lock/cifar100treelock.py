...
class cifar100tree:
	...
	def build_base_model(self):
		...
		conv1_c = Conv2D(64, (3, 3), padding='same',
						 input_shape=self.x_shape,kernel_regularizer=regularizers.l2(weight_decay),trainable=False)
		...
		conv2_c = Conv2D(64, (3, 3), padding='same',kernel_regularizer=regularizers.l2(weight_decay),trainable=False)
		...
		conv3_c = Conv2D(128, (3, 3), padding='same',kernel_regularizer=regularizers.l2(weight_decay),trainable=False)
		...
		conv4_c = Conv2D(128, (3, 3), padding='same',kernel_regularizer=regularizers.l2(weight_decay),trainable=False)
		...
		conv5_c = Conv2D(256, (3, 3), padding='same',kernel_regularizer=regularizers.l2(weight_decay),trainable=False)
		...
		conv6_c = Conv2D(256, (3, 3), padding='same',kernel_regularizer=regularizers.l2(weight_decay),trainable=False)
		...
		conv7_c = Conv2D(256, (3, 3), padding='same',kernel_regularizer=regularizers.l2(weight_decay),trainable=False)
		...
		conv8_c = Conv2D(512, (3, 3), padding='same',kernel_regularizer=regularizers.l2(weight_decay),trainable=False)
		...
		conv9_c = Conv2D(512, (3, 3), padding='same',kernel_regularizer=regularizers.l2(weight_decay),trainable=False)
		...
		conv10_c = Conv2D(512, (3, 3), padding='same',kernel_regularizer=regularizers.l2(weight_decay),trainable=False)
		...
		conv11_c = Conv2D(512, (3, 3), padding='same',kernel_regularizer=regularizers.l2(weight_decay),trainable=False)
...
if __name__ == '__main__':
	...
	val_coarse_acc = model.predict_root(xc_train[::5],yc_train[::5])
