...
class cifar100tree:
	...
	def fit(self,epochs):
		...
		for epoch in range(epochs):
			...
			# pdb.set_trace()
			for model in self.model_dict:
				self.model_dict[model].save_weights('weights/cifar100tree_roottrain_{}.h5'.format(model))
...
if __name__ == '__main__':
	...
	model = cifar100tree(weights="weights/cifar100vgg.h5",load_weights=False,save_acc="metrics/accuracy_2.csv",train=True)
